# Contributing to git-add-remote

First and foremost, thank you! We appreciate that you want to contribute to git-add-remote, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for git-add-remote**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for git-add-remote:

- star the [project](https://github.com/jonschlinkert/git-add-remote)
- tweet your support for git-add-remote
...
- **version**: please note the version of git-add-remote are you using
...
[so]: http://stackoverflow.com/questions/tagged/git-add-remote